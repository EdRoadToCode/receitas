...
function Navbar() {
    ...
    return (
        <nav className='nav'>
            <div className="logo">
                <Link to="/" className="nav__brand" id='logo'>L'Arte della Tavolla</Link>
            </div>
            <ul id='links' className={active}>
                ...
                <li id='apareceReceita' className="nav__item"><Link to="/receitas" className="nav__link">Feed</Link></li>
