...
import recortada from "./fotologo.png";
import './Login.css';
...
function Login() {
    ...
    return (
        <div className="container">
            <div className='logEsq'>
                <img src={recortada} alt="Logo" />
            </div>
            <div className='logDir'>
                ...
                >
                    ...
                    <Form.Item>
                        <Button type="primary" htmlType="submit" loading={loading} id='login-btn'>
                            Cadastrar
                        </Button>
                    </Form.Item>
                </Form>
